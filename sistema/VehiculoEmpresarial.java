public class VehiculoEmpresarial extends Vehiculo {
    ...
    public VehiculoEmpresarial(String marca, String modelo, String patente, String kilometraje, int velocidad, int cantDeButacas, int anioDeAdquisicion, String nombre, String apellido, String dni, int salario, TipoDeVehiculo tipoDeVehiculo) {
